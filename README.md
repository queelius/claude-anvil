...
| [bookwright](bookwright/) | Non-fiction book authoring: LaTeX + paired computational notebooks, multi-agent drafting and review | 0.2.1 |
| [pub-pipeline](pub-pipeline/) | Publication workflows: R (CRAN/JOSS/JSS) and Python (PyPI) | 0.8.1 |
