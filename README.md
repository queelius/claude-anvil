...
| [bookwright](bookwright/) | Non-fiction book authoring: LaTeX + paired computational notebooks, multi-agent drafting and review | 0.2.2 |
...
| [vista](vista/) | Surface salient research directions from highly-cited papers (live OpenAlex + PDF section extraction) | 0.2.1 |
